...
import { fadeBlurUp, sectionOrchestrator, maskCenter, staggerContainer, staggerItem, easeReveal, viewport } from "@/lib/framer-variants";
    ...
    <section id="location" className="section-spacing bg-soft-black">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          {/* Map — expanding clip mask reveal */}
          <motion.div
          ...
          >
            <iframe
              ...
              className="absolute inset-0 w-full h-full border-0 grayscale-[60%] opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-700"
          ...
          <motion.div className="flex flex-col gap-8" variants={fadeBlurUp}>
            ...
            >
              {[
                ...
                <motion.div key={item.title} className="flex flex-col gap-1" variants={staggerItem}>
